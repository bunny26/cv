...
<div class="templatemo-content-wrapper">
    <div class="templatemo-content">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="btn-group pull-left" id="templatemo_sort_btn">  
                        ...
                        <input type = "text" name = "idTest" class="form-control" placeholder="id" aria-describedby="basic-addon1" >
                    </div>
                    <br>
                    ...
                    <input type = "text" name = "namaTest" class="form-control" placeholder="id" aria-describedby="basic-addon1" >
                </div>
                <br>
                ...
                <input type = "date" name = "tanggal" class="form-control" placeholder="id" aria-describedby="basic-addon1" >
            </div>
            <br>
            <div class="input-group" class="templatemo-content-wrapper" >
                <span class="input-group-addon" id="basic-addon1" style="width: 70px;">
            ...
            <input type = "text" name = "testimoni" class="form-control" placeholder="id" aria-describedby="basic-addon1" >
        </div>
        <br>
